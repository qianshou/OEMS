    ...
    <div class="container">
      ...
      <div class="jumbotron">
        ...
        <table class="table table-hover">
              ...
              <tr><td style="text-align:right;">1.</td> <td>本场考试时间为20分钟，题目由40道不定项选择题和20道判断题组成，满分100分。</td></tr>
              <tr><td style="text-align:right;">2.</td> <td>考生使用准考证号和考生姓名全拼（例：zhangsan）进行登录。</td></tr>
              <tr><td style="text-align:right;">3.</td> <td>考生登录系统之后，可以点击“选择题”、“判断题”进行答题。</td></tr>
              <tr><td style="text-align:right;">4.</td> <td>考生每回答一道选择题或判断题，都需要点击“提交”按钮，将答案进行提交。</td></tr>
